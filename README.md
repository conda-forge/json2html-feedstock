...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/json2html-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14144&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/json2html-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `json2html` can be installed with:

```
conda install json2html
```

It is possible to list all of the versions of `json2html` available on your platform with:
